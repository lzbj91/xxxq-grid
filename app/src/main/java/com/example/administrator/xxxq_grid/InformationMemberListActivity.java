...
public class InformationMemberListActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_information_member_list);
    ...
    @Override
    protected void init() {
        recyclerView = (RecyclerView) findViewById(R.id.activity_information_member_list_recycle_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        refreshLayout = (RefreshLayout) findViewById(R.id.activity_information_member_list_refresh_view);
        ...
        click1 = (TextView) findViewById(R.id.activity_information_member_list_click1);
        click2 = (TextView) findViewById(R.id.activity_information_member_list_click2);
        click3 = (TextView) findViewById(R.id.activity_information_member_list_click3);

        click1.setOnClickListener(l);
        click2.setOnClickListener(l);
        click3.setOnClickListener(l);

        img1 = (ImageView) findViewById(R.id.activity_information_member_list_img1);
        img2 = (ImageView) findViewById(R.id.activity_information_member_list_img2);
    }
    ...
    View.OnClickListener l = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.activity_information_member_list_click1:
                    //刷新数据
                    log(1, "我默认综合排序");
                    ...
                    setClickState(1);
                    break;
                case R.id.activity_information_member_list_click2:
                    //刷新数据
                    if (currentClick != 2) {
                        //升序排列
                    ...
                    setClickState(2);
                    break;
                case R.id.activity_information_member_list_click3:
                    showDatePicker();
                    break;
            }
        }
    ...
    private void loadMemberList(final int type, final int page) {
        ...
        new HttpRequest().post(InformationMemberListActivity.this, "information/loadMemberList", uploadDataMap, new CallBackSuccess() {
            @Override
    ...
    private void setListData() {
        ...
        memberListAdapter.setOnItemClickListner(new BaseRecycleAdapter.OnItemClickListner() {
            ...
            public void onItemClickListner(View v, int position) {
                Intent intent = new Intent(InformationMemberListActivity.this, MemberDetailsHasListActivity.class);
    ...
    private void showDatePicker() {
        ...
        DatePickerDialog dialog = new DatePickerDialog(InformationMemberListActivity.this, AlertDialog.THEME_HOLO_LIGHT, new DatePickerDialog.OnDateSetListener() {
            @Override

...
public class InformationSupplierListActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_information_supplier_list);
    ...
    @Override
    protected void init() {
        recyclerView = (RecyclerView) findViewById(R.id.activity_information_supplier_list_recycle_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        refreshLayout = (RefreshLayout) findViewById(R.id.activity_information_supplier_list_refresh_view);
        refreshLayout.setPrimaryColorsId(R.color.color_green_theme, android.R.color.white);
        refreshLayout.setOnRefreshLoadMoreListener(new OnRefreshLoadMoreListener() {
            @Override
            public void onLoadMore(@NonNull RefreshLayout refreshLayout) {
                loadSupplierList(1, ++currentPage);
            }

            @Override
            public void onRefresh(@NonNull RefreshLayout refreshLayout) {
                loadSupplierList(0, 1);
            }
        });

        click1 = (TextView) findViewById(R.id.activity_information_supplier_list_click1);
        click2 = (TextView) findViewById(R.id.activity_information_supplier_list_click2);
        click3 = (TextView) findViewById(R.id.activity_information_supplier_list_click3);
        click4 = (TextView) findViewById(R.id.activity_information_supplier_list_click4);
        ...
        img1 = (ImageView) findViewById(R.id.activity_information_supplier_list_img1);
        img2 = (ImageView) findViewById(R.id.activity_information_supplier_list_img2);
        img3 = (ImageView) findViewById(R.id.activity_information_supplier_list_img3);
    }
    ...
    View.OnClickListener l = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.activity_information_supplier_list_click1:
                    //刷新数据
                    log(1, "我默认综合排序");
                    uploadDataMap.remove("num");
                    uploadDataMap.remove("money");
                    ...
                    setClickState(1);
                    break;
                case R.id.activity_information_supplier_list_click2:
                    //刷新数据
                    if (currentClick != 2) {
                        //升序排列
                        uploadDataMap.put("money", "up");
                        log(1, "我默认升序排列");
                        currentClick = 2;
                        temp = true;
                    } else {
                    ...
                    setClickState(2);
                    break;
                case R.id.activity_information_supplier_list_click3:
                    //刷新数据
                    if (currentClick != 3) {
                        //升序排列
                        log(1, "我默认升序排列");
                        uploadDataMap.put("num", "up");
                        currentClick = 3;
                        temp = true;
                    } else {
                        if (temp) {
                            //降序排列
                            uploadDataMap.put("num", "down");
                            temp = false;
                            log(2, "我重复点击一次,降序排列");
                        } else {
                            //升序排列
                    ...
                    setClickState(3);
                    break;
                case R.id.activity_information_supplier_list_click4:
                    showDatePicker();
                    break;
            }
        }
    ...
    protected void initData() {
        uploadDataMap.put("smart", true);
        loadSupplierList(2, 1);
    }

    private void loadSupplierList(final int type, final int page) {
        ...
        new HttpRequest().post(InformationSupplierListActivity.this, "information/loadSupplierList", uploadDataMap, new CallBackSuccess() {
            @Override
    ...
    private void setListData() {
        supplierListAdapter = new SupplierListAdapter(this, R.layout.adapter_suppliet_list, dataList, refreshLayout);
        ...
        supplierListAdapter.setOnItemClickListner(new BaseRecycleAdapter.OnItemClickListner() {
            ...
            public void onItemClickListner(View v, int position) {
                Intent intent = new Intent(InformationSupplierListActivity.this, SupplierDetailsHasListActivity.class);
    ...
    private void showDatePicker() {
        ...
        DatePickerDialog dialog = new DatePickerDialog(InformationSupplierListActivity.this, AlertDialog.THEME_HOLO_LIGHT, new DatePickerDialog.OnDateSetListener() {
            @Override

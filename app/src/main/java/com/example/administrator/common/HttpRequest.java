...
//    private final String FILE_URL = "http://192.168.200.72/insproject-file";
    ...
    private final String FILE_URL = "http://111.20.150.254:6018/insproject-file";
    ...
    //外网
//    private final String URL = "http://111.20.150.253:14332/insproject-web-app-grid/app/";
//    private final String FILE_URL = "http://111.20.150.253:14332/insproject-file/";
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (Boolean.parseBoolean(BaseUtils.toString(data.get("success")))) {
                    ...
                    if (data.get("message").equals("ACCOUNT_ERROR")) {
                        Handler handler = new Handler(Looper.getMainLooper());
                        handler.post(new Runnable() {
                            @Override
                            public void run() {

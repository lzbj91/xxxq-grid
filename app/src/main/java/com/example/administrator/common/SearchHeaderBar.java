...
public class SearchHeaderBar extends LinearLayout {
    ...
    public SearchHeaderBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        ...
        viewAppTitle = inflater.inflate(R.layout.layout_search_headerbar, null);
    ...
    static class MyViewHolder {
        ...
        public MyViewHolder(View v) {
            ...
            tvCenterTitle = (EditText) v.findViewById(R.id.tvCenterTitle);
